// src/components/admincomponent/PostProduct.jsx
...
const PostProduct = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${CATEGORY_API_ENDPOINT}/${formData.category}/subcategories`)
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" disabled={loading || !formData.title || !formData.price || !formData.category || !formData.subcategory}>
