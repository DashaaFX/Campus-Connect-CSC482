...
// Added direct APPROVED -> COMPLETED path for physical/ order completion
export const ORDER_ALLOWED_TRANSITIONS = {
  ...
  [ORDER_STATUSES.APPROVED]: [ORDER_STATUSES.PAID, ORDER_STATUSES.CANCELLED, ORDER_STATUSES.COMPLETED],
