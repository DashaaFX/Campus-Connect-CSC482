...
const Header = () => {
  ...
  return (
    <header className="px-4 py-12 text-white bg-gradient-to-r from-purple-600 to-orange-400">
      <div className="container mx-auto text-center">
        <div className="mb-6">
          <span className="inline-flex items-center px-4 py-2 text-sm font-medium bg-white rounded-full bg-opacity-20">
